...
meta_data <- read.csv("Data/Sample.Info.csv", stringsAsFactors = FALSE)
```
...
d10DMR_1way_aov_pH_modelsumm$comparison <- "Day_10"
```
...
#add a comparison column
d135DMR_1way_aov_pH_modelsumm$comparison <- "Day_135"
```
...
#add a comparison column
d145DMR_1way_aov_pH_modelsumm$comparison <- "Day_145"
...
#add a comparison column
ambDMR_1way_aov_pH_modelsumm$comparison <- "All_ambient"
```

write out ANOVA data to file
```{r}
#write ANOVA output to file
write.csv(rbind(d10DMR_1way_aov_pH_modelsumm,d135DMR_1way_aov_pH_modelsumm,d145DMR_1way_aov_pH_modelsumm,ambDMR_1way_aov_pH_modelsumm), "Output/DMR_1way_aov_modelsumm.csv", row.names = FALSE, quote = FALSE)
```
...
jpeg("Output/D10.DMR_heatmap.jpg", width = 600, height = 1000)
...
jpeg("Output/D135.DMR_heatmap.jpg", width = 600, height = 1000)
...
jpeg("Output/D145.DMR_heatmap.jpg", width = 800, height = 1000)
...
jpeg("Output/Time.DMR_heatmap.jpg", width = 700, height = 1000)
...
write.table(aov_0.05pH_d10DMR_bed,"Output/aov_0.05pH_d10DMR.bed", row.names = FALSE,col.names = FALSE, quote = FALSE,sep = "\t")
...
write.table(aov_0.05pH_d135DMR_bed,"Output/aov_0.05pH_d135DMR.bed", row.names = FALSE,col.names = FALSE, quote = FALSE,sep = "\t")
...
write.table(aov_0.05pH_d145DMR_bed,"Output/aov_0.05pH_d145DMR.bed", row.names = FALSE,col.names = FALSE, quote = FALSE,sep = "\t")
...
write.table(aov_0.05pH_ambDMR_bed,"Output/aov_0.05pH_ambDMR.bed", row.names = FALSE,col.names = FALSE, quote = FALSE,sep = "\t")
```
...
#make violin plots
jpeg("Output/DMR_size_distributions.jpg", width = 6, height = 4.5, units = "in", res = 300)
...
jpeg("Output/DMR_distribution_across_scaffolds.jpg", width = 10, height = 5, units = "in", res = 300)
...
jpeg("Output/DMR_distribution_by_scaffold_position.jpg", width = 6, height = 7, units = "in", res = 300)
...
jpeg("Output/pH.DMR_genom_feat_stacked_barplot.jpg", width = 6, height = 5, units = "in", res =300)
...
jpeg("Output/Time.DMR_genom_feat_stacked_barplot.jpg", width = 4, height = 7, units = "in", res =300)
