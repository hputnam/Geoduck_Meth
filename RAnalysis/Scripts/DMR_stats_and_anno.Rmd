...
aov_0.05pH_d145DMR_m <- aov_0.05pH_d145DMR_m[which(rownames(aov_0.05pH_d145DMR_m) %in% pull(d145DMR_2way_aov_pH_modelsumm[which(d145DMR_2way_aov_pH_modelsumm$`p.value_Initial.Treatment.Secondary.Treatment` < 0.05),],ID)),]
#remove extra text from column names
...
d10DMR_1way_aov_pH_modelsumm$scaffold <- gsub("\\:.*","", d10DMR_1way_aov_pH_modelsumm$ID)
d10DMR_1way_aov_pH_modelsumm$start <- gsub(".*\\:","", d10DMR_1way_aov_pH_modelsumm$ID)
d10DMR_1way_aov_pH_modelsumm$start <- gsub("-.*","", d10DMR_1way_aov_pH_modelsumm$start)
d10DMR_1way_aov_pH_modelsumm$end <- gsub(".*-","",  d10DMR_1way_aov_pH_modelsumm$ID)
d10DMR_1way_aov_pH_modelsumm <- d10DMR_1way_aov_pH_modelsumm[,c(1,(ncol(d10DMR_1way_aov_pH_modelsumm)-2):ncol(d10DMR_1way_aov_pH_modelsumm),2:(ncol(d10DMR_1way_aov_pH_modelsumm)-3))]
#order by pvalue
d10DMR_1way_aov_pH_modelsumm <- d10DMR_1way_aov_pH_modelsumm[order(d10DMR_1way_aov_pH_modelsumm$p.value),]
write.csv(d10DMR_1way_aov_pH_modelsumm,"RAnalysis/Output/aov_pH_d10DMR.csv", row.names = FALSE, quote = FALSE)

#write out d135 DMR bed file
d135DMR_1way_aov_pH_modelsumm$scaffold <- gsub("\\:.*","", d135DMR_1way_aov_pH_modelsumm$ID)
d135DMR_1way_aov_pH_modelsumm$start <- gsub(".*\\:","", d135DMR_1way_aov_pH_modelsumm$ID)
d135DMR_1way_aov_pH_modelsumm$start <- gsub("-.*","", d135DMR_1way_aov_pH_modelsumm$start)
d135DMR_1way_aov_pH_modelsumm$end <- gsub(".*-","",  d135DMR_1way_aov_pH_modelsumm$ID)
d135DMR_1way_aov_pH_modelsumm <- d135DMR_1way_aov_pH_modelsumm[,c(1,(ncol(d135DMR_1way_aov_pH_modelsumm)-2):ncol(d135DMR_1way_aov_pH_modelsumm),2:(ncol(d135DMR_1way_aov_pH_modelsumm)-3))]
#order by pvalue
d135DMR_1way_aov_pH_modelsumm <- d135DMR_1way_aov_pH_modelsumm[order(d135DMR_1way_aov_pH_modelsumm$p.value),]
write.csv(d135DMR_1way_aov_pH_modelsumm,"RAnalysis/Output/aov_pH_d135DMR.csv", row.names = FALSE, quote = FALSE)

#write out d145 DMR bed file
d145DMR_2way_aov_pH_modelsumm$scaffold <- gsub("\\:.*","", d145DMR_2way_aov_pH_modelsumm$ID)
d145DMR_2way_aov_pH_modelsumm$start <- gsub(".*\\:","", d145DMR_2way_aov_pH_modelsumm$ID)
d145DMR_2way_aov_pH_modelsumm$start <- gsub("-.*","", d145DMR_2way_aov_pH_modelsumm$start)
d145DMR_2way_aov_pH_modelsumm$end <- gsub(".*-","",  d145DMR_2way_aov_pH_modelsumm$ID)
d145DMR_2way_aov_pH_modelsumm <- d145DMR_2way_aov_pH_modelsumm[,c(1,(ncol(d145DMR_2way_aov_pH_modelsumm)-2):ncol(d145DMR_2way_aov_pH_modelsumm),2:(ncol(d145DMR_2way_aov_pH_modelsumm)-3))]
#order by pvalue
d145DMR_2way_aov_pH_modelsumm <- d145DMR_2way_aov_pH_modelsumm[order(d145DMR_2way_aov_pH_modelsumm$p.value_Initial.Treatment.Secondary.Treatment),]
write.csv(d145DMR_2way_aov_pH_modelsumm,"RAnalysis/Output/aov_pH_d145DMR.csv", row.names = FALSE, quote = FALSE)


#write out amb DMR bed file
ambDMR_1way_aov_pH_modelsumm$scaffold <- gsub("\\:.*","", ambDMR_1way_aov_pH_modelsumm$ID)
ambDMR_1way_aov_pH_modelsumm$start <- gsub(".*\\:","", ambDMR_1way_aov_pH_modelsumm$ID)
ambDMR_1way_aov_pH_modelsumm$start <- gsub("-.*","", ambDMR_1way_aov_pH_modelsumm$start)
ambDMR_1way_aov_pH_modelsumm$end <- gsub(".*-","",  ambDMR_1way_aov_pH_modelsumm$ID)
ambDMR_1way_aov_pH_modelsumm <- ambDMR_1way_aov_pH_modelsumm[,c(1,(ncol(ambDMR_1way_aov_pH_modelsumm)-2):ncol(ambDMR_1way_aov_pH_modelsumm),2:(ncol(ambDMR_1way_aov_pH_modelsumm)-3))]
#order by pvalue
ambDMR_1way_aov_pH_modelsumm <- ambDMR_1way_aov_pH_modelsumm[order(ambDMR_1way_aov_pH_modelsumm$p.value),]
write.csv(ambDMR_1way_aov_pH_modelsumm,"RAnalysis/Output/aov_pH_timeDMR.csv", row.names = FALSE, quote = FALSE)
