...
#write out date
write.table(d10DMR_sig.bed, "RAnalysis/Output/aov_pH_d10DMR.bed", sep = "\t",row.names = F, col.names = F, quote = F)
...
#write out date
write.table(d135DMR_sig.bed, "RAnalysis/Output/aov_pH_d135DMR.bed", sep = "\t",row.names = F, col.names = F, quote = F)
...
#write out date
write.table(d145DMR_sig.bed, "RAnalysis/Output/aov_pH_d145DMR.bed", sep = "\t",row.names = F, col.names = F, quote = F)
...
#write out date
write.table(ambDMR_sig.bed, "RAnalysis/Output/aov_time_ambDMR.bed", sep = "\t",row.names = F, col.names = F, quote = F)
