...
#subsetting GO slims to reduce heatmap size and focus on rapid-inducible vs. persistent
...
ggsave(file="RAnalysis/Figs/GOslim_MF_facetsXterm", XXe, width = 8, height = 20, units = c("in"))
