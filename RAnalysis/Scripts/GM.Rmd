...
write.csv(Uniprots, "/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Genome/Uniprot.IDS.csv") #save to file

#Obtain GO terms from Uniprot using Uniprot.IDS.csv https://www.uniprot.org/uploadlists/

GOs <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Genome/Uniprot_GOs.csv", header=TRUE, sep=",", na.string="NA", stringsAsFactors = F) #read in gene ontology information
...
write.table(ints_all.annot, 'RAnalysis/Output/DMGs_consistent_INT.tsv', sep='\t', row.names=FALSE)
...
pdf("RAnalysis/Output/D10.DMG_Abs_Meth.pdf", width = 1.5, height= 4)
