...
Flow1 <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Flow1_Juvenile_Geoduck.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
#flow values measured in ml/10 sec
Flow1$Rate <- (((Flow1$Rate1 + Flow1$Rate2)/2)*6)/1000*60 #calculate flow rate in liters per hour
Flow1.Rate <- aggregate(Rate ~ Treatment, data=Flow1, FUN=mean)
Flow1.Rate$se <- aggregate(Rate ~ Treatment, data=Flow1, FUN=std.error)
...
Flow2 <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Flow2_Juvenile_Geoduck.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
#flow values measured in ml/15 sec
Flow2$Rate <- ((Flow2$Rate1)*4)/1000*60 #calculate flow rate in liters per hour
Flow2.Rate <- aggregate(Rate ~ Treatment, data=Flow2, FUN=mean)
Flow2.Rate$se <- aggregate(Rate ~ Treatment, data=Flow2, FUN=std.error)
mean(Flow2$Rate)
std.error(Flow2$Rate)
...
cells.1 <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Cell_Counts_Juvenile_Geoduck_Exp1.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
...
cells.2 <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Cell_Counts_Juvenile_Geoduck_Exp2.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
...
#Avtech_pH_data.csv
pH <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Avtech_pH_data.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
...
temp <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/Avtech_temp_data.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
...
ggsave(file="/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Figs/Fig.S1.pdf", FigureS1, width = 6, height = 8, units = c("in"))
```
...
path <-("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/pH_Calibration_Files/") #set path to calibration file folder
...
SW.chem <- read.csv("/Users/hputnam/MyProjects/Geoduck_Meth/RAnalysis/Data/SW_Chem_Juvenile_Geoduck.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
...
#write.table(Time.Amb.sig, '/home/hputnam/Geoduck_BS/RAnalysis/Output/Time_sig.tsv', sep='\t', row.names=FALSE)
...
write.table(Time.Amb.annot, '/home/hputnam/Geoduck_BS/RAnalysis/Output/Table_S1_Time_sig_annot.tsv', sep='\t', row.names=FALSE)
```
```{r}
...
write.table(D10.sig, '/home/hputnam/Geoduck_BS/RAnalysis/Output/D10_sig.tsv', sep='\t', row.names=FALSE)
...
write.table(D135.sig, '/home/hputnam/Geoduck_BS/RAnalysis/Output/D135_sig.tsv', sep='\t', row.names=FALSE)
...
write.table(D145.sig, '/home/hputnam/Geoduck_BS/RAnalysis/Output/D145_sig.tsv', sep='\t', row.names=FALSE)
...
write.table(ints_all.annot, '/home/hputnam/Geoduck_BS/RAnalysis/Output/DMGs_consistent_INT.tsv', sep='\t', row.names=FALSE)
...
#ALL= should be all possible genes in D10, D135, and D145

ALL<-as.data.frame(unique(Genes$gene)) #set the all transcripts list
colnames(ALL) <-c("gene")
...
write.csv(MF.INT , file = "/home/hputnam/Geoduck_BS/RAnalysis/Output/MF_Sig_Enriched_GO.05_INT.csv")
write.csv(CC.INT , file = "/home/hputnam/Geoduck_BS/RAnalysis/Output/CC_Sig_Enriched_GO.05_INT.csv")
write.csv(BP.INT , file = "/home/hputnam/Geoduck_BS/RAnalysis/Output/BP_Sig_Enriched_GO.05_INT.csv")
```
...
pdf("/home/hputnam/Geoduck_BS/RAnalysis/Output/Time.DMG_Abs.pdf")
pheatmap(Time.Amb.mat, clustering_method = "average", 
...
pdf("/home/hputnam/Geoduck_BS/RAnalysis/Output/D10.DMG_Abs_Meth.pdf", width = 1.5, height= 4)
...
pdf("/home/hputnam/Geoduck_BS/RAnalysis/Output/D135.DMG_Abs_Meth.pdf", width = 1.5, height= 4)
...
pdf("/home/hputnam/Geoduck_BS/RAnalysis/Output/D145.DMG_Abs_Meth.pdf", width = 3, height= 5)
...
for (i in 1:nrow(D10.nuc.genes)){
  ...
  ggsave(temp_plot, file=paste0("/home/hputnam/Geoduck_BS/RAnalysis/Output/NUC_D10plot_", D10.nuc.genes$gene[i],"_",D10.nuc.genes$protein.name.short[i],".png"), width = 14, height = 10, units = "cm")
}
...
for (i in 1:nrow(D10.galac.genes)){
  ...
  ggsave(temp_plot, file=paste0("/home/hputnam/Geoduck_BS/RAnalysis/Output/Galac_D10plot_", D10.galac.genes$gene[i],"_",D10.galac.genes$protein.name.short[i],".png"), width = 14, height = 10, units = "cm")
}
...
for (i in 1:nrow(D135.nuc.genes)){
  ...
  ggsave(temp_plot, file=paste0("/home/hputnam/Geoduck_BS/RAnalysis/Output/NUC_D135plot_", D135.nuc.genes$gene[i],"_",D135.nuc.genes$protein.name.short[i],".png"), width = 14, height = 10, units = "cm")
}
...
for (i in 1:nrow(D135.galac.genes)){
  ...
  ggsave(temp_plot, file=paste0("/home/hputnam/Geoduck_BS/RAnalysis/Output/Galac_D135plot_", D135.galac.genes$gene[i],"_",D135.galac.genes$protein.name.short[i],".png"), width = 14, height = 10, units = "cm")
}
...
for (i in 1:nrow(D145.nuc.genes)){
  ...
  ggsave(temp_plot, file=paste0("/home/hputnam/Geoduck_BS/RAnalysis/Output/NUC_D145plot_", D145.nuc.genes$gene[i],"_",D145.nuc.genes$protein.name.short[i],".png"), width = 14, height = 10, units = "cm")
}
...
for (i in 1:nrow(D145.galac.genes)){
  ...
  ggsave(temp_plot, file=paste0("/home/hputnam/Geoduck_BS/RAnalysis/Output/Galac_D145plot_", D145.galac.genes$gene[i],"_",D145.galac.genes$protein.name.short[i],".png"), width = 14, height = 10, units = "cm")
}
