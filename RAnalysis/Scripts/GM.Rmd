...
D135.chondrocyte.genes <- D135.sig.annot[grep("GO:0003429", D135.sig.annot$GO.IDs), ]
...
D145.chondrocyte.genes <- D145.sig.annot[grep("GO:0003429", D145.sig.annot$GO.IDs), ]
...
pheatmap(Time.Amb.mat, clustering_method = "average", 
         ...
         show_colnames =TRUE, scale="none") #plot heatmap of all DEG by group
dev.off()
```
...
pheatmap(D135.mat, clustering_method = "average", 
         clustering_distance_rows="euclidean", show_rownames =TRUE, cluster_cols=FALSE,cluster_rows = FALSE,fontsize_row = 0.8,
         show_colnames =TRUE, scale="none") #plot heatmap of all DEG by group
dev.off()
```
...
D145.mat <- D145[,2:7]
D145.mat.norm <- D145.mat-rowMeans(D145.mat)
...
pheatmap(D145.mat.norm, clustering_method = "average", 
         clustering_distance_rows="euclidean", show_rownames =TRUE, cluster_rows=FALSE, cluster_cols=FALSE, gaps_col = c(2,4),
         fontsize_row = 1, show_colnames =TRUE, scale="none") #plot heatmap of all DEG by group
dev.off()

D145.mat.1 <- D145.mat[,c(1:2)]
D145.mat.1 <- as.data.frame(D145.mat.1)
D145.mat.1$gene <-rownames(D145.mat.1)
D145.mat.1$diff <- D145.mat.1$per.meth.AmbientLow - D145.mat.1$per.meth.AmbientAmbient
...
D145.mat.2$diff <- D145.mat.2$per.meth.LowLow - D145.mat.2$per.meth.LowAmbient
...
D145.mat.3$diff <- D145.mat.3$per.meth.Super.LowLow - D145.mat.3$per.meth.Super.LowAmbient
