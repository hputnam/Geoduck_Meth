...
knitr::opts_knit$set(root.dir = '/home/shared/8TB_HDD_02/strigg/Geoduck_Meth')
```
...
Fig.Exp1.size <- ggplot(Init.Shell.size, aes(x=Day.Num, y=avg.Arel, group=Treatment)) + 
  ...
  geom_point(aes(colour=Treatment), size = 3, position = position_dodge(width = 0.6), alpha = 0.7) +
  ...
  annotate("text", x=22, y=1.6, label = "c", size = 3) + 
  #add text to the graphic for posthoc letters
  annotate("text",x = 3, y = 3.5, label = "n = 4", size = 3, color = "blue") +
  annotate("text",x = 3, y = 3.35, label = "n = 4", size = 3, color = "mediumvioletred") +
  annotate("text",x = 3, y = 3.2, label = "n = 4", size = 3, color = "red") +
  annotate("text",x = 12, y = 3.5, label = "n = 16", size = 3, color = "blue") +
  annotate("text",x = 12, y = 3.35, label = "n = 16", size = 3, color = "mediumvioletred") +
  annotate("text",x = 12, y = 3.2, label = "n = 16", size = 3, color = "red") +
  annotate("text",x = 22, y = 3.5, label = "n = 16", size = 3, color = "blue") +
  annotate("text",x = 22, y = 3.35, label = "n = 16", size = 3, color = "mediumvioletred") +
  annotate("text",x = 22, y = 3.2, label = "n = 16", size = 3, color = "red") +
  xlab("Days") +
  ylab("fold change in sizerelative to day 1") +
  ylim(0.5,3.5) +
  theme_bw() + #Set the background color
...
Fig.CG.size <- ggplot(CG.Shell.size, aes(x=Day, y=avg.Arel, group=Treatment)) + 
  ...
  annotate("text", x=0.6, y= 4, label = "n = 28", size = 3, color = "blue") + #add text to the graphic for sample size
  annotate("text", x=1, y=4, label = "n = 53", size = 3, color = "mediumvioletred") + #add text to the graphic for sample size
  annotate("text", x=1.4, y=4, label = "n =54", size = 3, color = "red") + #add text to the graphic for sample size
  xlab("Days") +
  ylab("fold change in size relative to day 23") +
  ylim(0.5,4) +
  theme_bw() + #Set the background color
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, hjust=0.5), #Set the text angle
        axis.line = element_line(color = 'black'), #Set the axes color
...
Fig.Exp2.D10.size <- ggplot(Day145, aes(x=Secondary, y=avg.Arel, group=Treatment)) + 
  ...
  scale_color_manual(values=c("blue", "mediumvioletred","red")) +
  geom_point(aes(colour=Treatment), size = 3, position = position_dodge(width = 0.05), alpha = 0.7) +
  scale_fill_manual(values=c("blue", "mediumvioletred","red")) +
  ...
  annotate("text", x=0.85, y=1.6, label = "n = 6", size = 3, color = "blue") + #add text to the graphic for sample size
  annotate("text", x=0.85, y=1.55, label = "n = 12", size = 3, color = "mediumvioletred") + #add text to the graphic for sample size
  annotate("text", x=0.85, y=1.5, label = "n = 12", size = 3, color = "red") + #add text to the graphic for sample size
    annotate("text", x=2.2, y=1.6, label = "n = 6", size = 3, color = "blue") + #add text to the graphic for sample size
  annotate("text", x=2.2, y=1.55, label = "n = 12", size = 3, color = "mediumvioletred") + #add text to the graphic for sample size
  annotate("text", x=2.2, y=1.5, label = "n = 12", size = 3, color = "red") + #add text to the graphic for sample size
  xlab("Secondary Treatment") +
  ylab("fold change in size relative to day 135") +
  ylim(0.5,1.6) +
  theme_bw() + #Set the background color
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, hjust=0.5), #Set the text angle
        axis.line = element_line(color = 'black'), #Set the axes color
...
Fig.Exp2.D23.size <- ggplot(Day158, aes(x=Secondary, y=avg.Arel, group=Treatment)) +
  ...
  annotate("text", x=c(0.85,0.85,0.85,2.2,2.2), y=c(0.95,1.04,1.15, 0.88,0.97), label = "ab", size = 3) + #add text to the graphic for posthoc letters
    annotate("text", x=0.85, y=1.6, label = "n = 8", size = 3, color = "blue") + #add text to the graphic for sample size
  annotate("text", x=0.85, y=1.55, label = "n = 14", size = 3, color = "mediumvioletred") + #add text to the graphic for sample size
  annotate("text", x=0.85, y=1.5, label = "n = 14", size = 3, color = "red") + #add text to the graphic for sample size
    annotate("text", x=2.2, y=1.6, label = "n = 8", size = 3, color = "blue") + #add text to the graphic for sample size
  annotate("text", x=2.2, y=1.55, label = "n = 15", size = 3, color = "mediumvioletred") + #add text to the graphic for sample size
  annotate("text", x=2.2, y=1.5, label = "n = 16", size = 3, color = "red") + #add text to the graphic for sample size
  xlab("Secondary Treatment") +
  ylab("fold change in size relative to day 135") +
  ylim(0.5,1.6) +
  theme_bw() + #Set the background color
...
Figure1.Size <- ggarrange(Fig.Exp1.size,Fig.CG.size, Fig.Exp2.D10.size, Fig.Exp2.D23.size, ncol=4, legend = "bottom", labels = "AUTO", common.legend = T)
...
#used this file: https://gannet.fish.washington.edu/Atumefaciens/20191105_swoose_pgen_v074_renaming/Panopea-generosa-v1.0.a4.gene.gff3
...
multiIntersectBed -i \
RAnalysis/Data/OSF/Time/fEPI-41_S38_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-42_S39_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-43_S40_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-44_S41_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-119_S31_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-120_S32_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-135_S35_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-136_S36_L005_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-151_S2_L002_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-152_S3_L002_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-153_S4_L002_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-154_S5_L002_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-181_S16_L003_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-182_S17_L003_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-184_S18_L003_5x.tab \
RAnalysis/Data/OSF/Time/fEPI-185_S19_L003_5x.tab \
...
multiIntersectBed -i \
RAnalysis/Data/OSF/D10/fEPI-103_S27_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-104_S28_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-111_S29_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-113_S30_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-119_S31_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-120_S32_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-127_S33_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-128_S34_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-135_S35_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-136_S36_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-143_S37_L005_5x.tab \
RAnalysis/Data/OSF/D10/fEPI-145_S38_L005_5x.tab \
...
multiIntersectBed -i \
RAnalysis/Data/OSF/D135/fEPI-151_S2_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-152_S3_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-153_S4_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-154_S5_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-159_S6_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-160_S7_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-161_S8_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-162_S9_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-167_S10_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-168_S11_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-169_S12_L002_5x.tab \
RAnalysis/Data/OSF/D135/fEPI-170_S13_L002_5x.tab \
...
multiIntersectBed -i \
RAnalysis/Data/OSF/D145/fEPI-175_S14_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-176_S15_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-181_S16_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-182_S17_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-184_S18_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-185_S19_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-187_S20_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-188_S21_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-193_S22_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-194_S23_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-199_S24_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-200_S25_L003_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-205_S26_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-206_S27_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-208_S28_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-209_S29_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-214_S30_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-215_S31_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-220_S32_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-221_S33_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-226_S34_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-227_S35_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-229_S36_L004_5x.tab \
RAnalysis/Data/OSF/D145/fEPI-230_S37_L004_5x.tab \
...
Load filtered methylation counts (see OSF Repository for all data files)
## Time dataset
```{r}
# Time
...
MD.Time <- merge(meth.data.T %>% mutate(Sample.ID = gsub("f","", Sample.ID)),sample.info, by="Sample.ID")
```
...
MD.D10 <- merge(meth.data.D10%>% mutate(Sample.ID = gsub("f","", Sample.ID)), sample.info, by="Sample.ID")
```
...
MD.D135 <- merge(meth.data.D135%>% mutate(Sample.ID = gsub("f","", Sample.ID)), sample.info, by="Sample.ID")
```
...
MD.D145 <- merge(meth.data.D145%>% mutate(Sample.ID = gsub("f","", Sample.ID)), sample.info, by="Sample.ID")
```
...
### H.P. not sure what 'results line' is. I couldn't get it to not produce the error so just continued running the code below.
...
write.table(Time.Amb.annot, 'RAnalysis/Output/Supplemental_Tables/TableS10_Time_sig_annot.tsv', sep='\t', row.names=FALSE)
...
write.csv(sig.GO.Time , file = "RAnalysis/Output/Supplemental_Tables/TableS11_sig.GO.Time.csv")
...
write.table(D10.sig.annot, 'RAnalysis/Output/Supplemental_Tables/TableS12_D10_sig_annot.tsv', sep='\t', row.names=FALSE)
...
write.csv(sig.GO.D10 , file = "RAnalysis/Output/Supplemental_Tables/TableS13_sig.GO.D10.csv")
...
write.table(D135.sig.annot, 'RAnalysis/Output/Supplemental_Tables/TableS14_D135_sig_annot.tsv', sep='\t', row.names=FALSE)
...
write.csv(sig.GO.D135 , file = "RAnalysis/Output/Supplemental_Tables/TableS15_sig.GO.D135.csv")
...
write.table(D145.sig.int.annot, 'RAnalysis/Output/Supplemental_Tables/TableS16_D145_sig_annot_Interactions.tsv', sep='\t', row.names=FALSE)
...
write.csv(sig.GO.D145 , file = "RAnalysis/Output/Supplemental_Tables/TableS17_sig.GO.D145.Interactions.csv")
...
write.table(ints_all.annot, 'RAnalysis/Output/Supplemental_Tables/TableS18_DMGs_persist.tsv', sep='\t', row.names=FALSE)
...
write.csv(sig.GO.Persist , file = "RAnalysis/Output/Supplemental_Tables/TableS19_sig.GO.Persistent.annot.csv")
...
D145.mat.1[D145.mat.1 == 0] <- 0.01
D145.mat.1$FC <- D145.mat.1$`pH 7.9 -> pH 7.4`/D145.mat.1$`pH 7.9 -> pH 7.9`
A <- round(mean(D145.mat.1$diff),2)
a <- round(mean(D145.mat.1$FC),2)
...
D145.mat.2[D145.mat.2 == 0] <- 0.01
D145.mat.2$FC <- D145.mat.2$`pH 7.4 -> pH 7.4`/D145.mat.2$`pH 7.4 -> pH 7.9` 
M <-round(mean(D145.mat.2$diff),2)
m <-round(mean(D145.mat.2$FC),2)
...
D145.mat.3[D145.mat.3 == 0] <- 0.01
D145.mat.3$FC <- D145.mat.3$`pH 7.0 -> pH 7.4`/ D145.mat.3$`pH 7.0 -> pH 7.9`
L <-round(mean(D145.mat.3$diff), 2)
l <-round(mean(D145.mat.3$FC), 2)
...
#add column to sig.GO dataframes to denote sampling time point
sig.GO.D10$TP <- "Day10"
...
#create list objects where each list item is a vector containing genes, uniprot ids, or taxa ids for each line 
split_byGO_gene <- strsplit(as.character(byGO$gene), "; ") #split into multiple gene ids
split_byGO_uniprot <- strsplit(as.character(byGO$uniprot), "; ") #split into multiple uniprot ids
split_byGO_taxa <- strsplit(as.character(byGO$uniprot_taxa.id), "; ") #split into multiple taxa ids

#create a new data frame that lists each gene, uniprot ID, and taxa id on a separate line (so the GO IDs are listed multiple times for each gene). 
#For the first data.frame Gene.byGO.IDs, I'm adding all the data from byGO and this will be maintained when it is merged with the uniprot info
Gene.byGO.IDs <- data.frame(GO.IDs = rep.int(byGO$GO.IDs, sapply(split_byGO_gene, length)), over_represented_pvalue = rep.int(byGO$over_represented_pvalue, sapply(split_byGO_gene, length)), under_represented_pvalue = rep.int(byGO$under_represented_pvalue, sapply(split_byGO_gene, length)) , numDEInCat = rep.int(byGO$numDEInCat, sapply(split_byGO_gene, length)), numInCat = rep.int(byGO$numInCat, sapply(split_byGO_gene, length)), term = rep.int(byGO$term, sapply(split_byGO_gene, length)), ontology = rep.int(byGO$ontology, sapply(split_byGO_gene, length)), Cat = rep.int(byGO$Cat, sapply(split_byGO_gene, length)),GO.Slim.Term = rep.int(byGO$GO.Slim.Term, sapply(split_byGO_gene, length)),TP = rep.int(byGO$TP, sapply(split_byGO_gene, length)), gene = unlist(split_byGO_gene)) 

#create a dataframe containing the GO.IDs and uniprot IDs all listed on separate lines
unip.byGO.IDs <- data.frame(GO.IDs = rep.int(byGO$GO.IDs, sapply(split_byGO_uniprot, length)), uniprot = unlist(split_byGO_uniprot)) 

#create a dataframe containing the GO.IDs and uniprot taxa IDs all listed on separate lines

taxa.byGO.IDs <- data.frame(GO.IDs = rep.int(byGO$GO.IDs, sapply(split_byGO_taxa, length)), uniprot_taxa.id = unlist(split_byGO_taxa)) 

#merge the dataframes with everything listed on separate lines
byGO_long <- cbind(Gene.byGO.IDs, "uniprot" =unip.byGO.IDs[,"uniprot"],uniprot_taxa.id =taxa.byGO.IDs[,"uniprot_taxa.id"])

#remove the species from the taxa id
byGO_long$uniprot_taxa.id <- gsub("_.*", "",byGO_long$uniprot_taxa.id)

#re-order the df by slim, timepoint, then pvalue
byGO_long  <- byGO_long[order(byGO_long$GO.Slim.Term,byGO_long$TP,byGO_long$over_represented_pvalue),]

# paste gene uniprot id next to terms
for (i in 1:nrow(byGO_long)){
  byGO_long$taxa.id[i] <- paste(unique(unname(byGO_long[grep(byGO_long$GO.IDs[i],byGO_long$GO.IDs),"uniprot_taxa.id"])), collapse = "; ")
  
}

byGO_long_term_gene <- unique(byGO_long[,-grep("^gene$|uniprot", colnames(byGO_long))])

byGO_long_term_gene$term_gene <- paste0(byGO_long_term_gene$term, " (",byGO_long_term_gene$taxa.id,")")


### add order column to order terms by p.value in heatmap
byGO_long_term_gene <- byGO_long_term_gene %>% arrange(GO.Slim.Term, over_represented_pvalue) %>% mutate(order = row_number())


###make the same order number for duplicate terms so that terms found across timepoints can be plotted in the same row
#extract the order number for the term with the lowest p.value
byGO_long_term_gene_rank <- byGO_long_term_gene %>% group_by(term_gene) %>% dplyr::slice(which.min(order))
#save only the term_gene and order columns so these can be merged with the main df
byGO_long_term_gene_rank <- byGO_long_term_gene_rank[,c("term_gene", "order")]
#rename the order column that will be merged
colnames(byGO_long_term_gene_rank) <- c("term_gene", "order2")                     
#merge the new order numbers with the main df                      
byGO_long_term_gene <- merge(byGO_long_term_gene, byGO_long_term_gene_rank, by = "term_gene")
                       
#plot all BP categories           
FigS5<-  byGO_long_term_gene %>% filter(ontology=="BP", TP!= "Persistent") %>%
  ggplot(., aes(x = TP, y = order2)) + 
  geom_tile(aes(fill =over_represented_pvalue)) + 
  facet_grid(GO.Slim.Term ~ ., scales = "free_y", labeller = label_wrap_gen(width = 5, multi_line = TRUE))+
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
  panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
  ...
  axis.title.x = element_blank(),
  axis.title.y = element_blank()) + scale_y_continuous(breaks = unique(byGO_long_term_gene$order2),
    labels = unique(byGO_long_term_gene$term_gene),expand = c(0,0)) 

#Persist.GO.Sig <- ggarrange(PersistGO.BP,PersistGO.MF, ncol=2, common.legend = TRUE, legend="bottom")
ggsave(file="RAnalysis/Figs/FigS5_BP_all.pdf", FigS5, width = 10, height = 16, units = c("in"))


#subset GO slims to reduce heatmap size and focus on those that are not in NA slim or greater than 1-2 terms

Fig7<-  byGO_long_term_gene %>% filter(ontology=="BP", TP!= "Persistent",GO.Slim.Term %in% c("cell organization and biogenesis","signal transduction", "transport", "developmental processes", "protein metabolism")) %>%
  ggplot(., aes(x = TP, y = order2)) + 
  geom_tile(aes(fill =over_represented_pvalue)) + 
  facet_grid(factor(GO.Slim.Term, levels = c("cell organization and biogenesis","signal transduction", "developmental processes", "protein metabolism", "transport")) ~ .,scales = "free_y", labeller = label_wrap_gen(width = 5, multi_line = TRUE))+
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
  panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
  strip.text.y = element_text(angle=0, size = 12),
  strip.text.x = element_text(size = 20),
...
ggsave(file="RAnalysis/Figs/Fig7_BP_subset.pdf", Fig7, width = 8, height = 10, units = c("in"))



FigS6<-  byGO_long_term_gene %>% filter(ontology=="MF",TP!= "Persistent") %>%
  ggplot(., aes(x = TP, y = order2)) + 
  geom_tile(aes(fill =over_represented_pvalue)) + 
  facet_grid(GO.Slim.Term ~ .,scales = "free_y", labeller = label_wrap_gen(width = 5, multi_line = TRUE))+
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
...
ggsave(file="RAnalysis/Figs/FigS6_MF_all.pdf", FigS6, width = 8, height = 20, units = c("in"))
