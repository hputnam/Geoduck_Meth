...
setwd("~/MyProjects/Geoduck_Meth/Extracted/") #set working

sample.info <- read.csv("../Sample.Info.csv", header=T, sep=",", na.string="NA", stringsAsFactors = F)

Data <- read.csv("filtered.52.all.bed", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
Data <- Data[,1:3]
...
epi.41 <- read.csv("EPI-41.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.42 <- read.csv("EPI-42.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.43 <- read.csv("EPI-43.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.44 <- read.csv("EPI-44.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.103 <- read.csv("EPI-103.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.104 <- read.csv("EPI-104.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.111 <- read.csv("EPI-111.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.113 <- read.csv("EPI-113.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.119 <- read.csv("EPI-119.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.120 <- read.csv("EPI-120.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.127 <- read.csv("EPI-127.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.128 <- read.csv("EPI-128.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.135 <- read.csv("EPI-135.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.136 <- read.csv("EPI-136.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.143 <- read.csv("EPI-143.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.145 <- read.csv("EPI-145.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.151 <- read.csv("EPI-151.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.152 <- read.csv("EPI-152.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.153 <- read.csv("EPI-153.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.154 <- read.csv("EPI-154.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.159 <- read.csv("EPI-159.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.160 <- read.csv("EPI-160.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.161 <- read.csv("EPI-161.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.162 <- read.csv("EPI-162.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.167 <- read.csv("EPI-167.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.168 <- read.csv("EPI-168.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.169 <- read.csv("EPI-169.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.170 <- read.csv("EPI-170.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.175 <- read.csv("EPI-175.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.176 <- read.csv("EPI-176.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.181 <- read.csv("EPI-181.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.182 <- read.csv("EPI-182.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.184 <- read.csv("EPI-184.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.185 <- read.csv("EPI-185.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.187 <- read.csv("EPI-187.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.188 <- read.csv("EPI-188.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.193 <- read.csv("EPI-193.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.194 <- read.csv("EPI-194.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.199 <- read.csv("EPI-199.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.200 <- read.csv("EPI-200.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.205 <- read.csv("EPI-205.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.206 <- read.csv("EPI-206.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.208 <- read.csv("EPI-208.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.209 <- read.csv("EPI-209.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.214 <- read.csv("EPI-214.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.215 <- read.csv("EPI-215.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.220 <- read.csv("EPI-220.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.221 <- read.csv("EPI-221.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.226 <- read.csv("EPI-226.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.227 <- read.csv("EPI-227.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.229 <- read.csv("EPI-229.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
epi.230 <- read.csv("EPI-230.5x.cov.CpG", header=F, sep="", na.string="NA", stringsAsFactors = F) #read in data file
...
ggsave(file="../Methylation_Level.pdf", Meth.Level, width =6, height = 6, units = c("in"))

Time <- arrangeGrob(Fig.time.amb.per.meth, ncol=1)
ggsave(file="../Time.pdf", Time, width =6, height = 6, units = c("in"))

D10 <- arrangeGrob(Fig.D10.per.meth, ncol=1)
ggsave(file="../D10.trt.pdf", D10, width =6, height = 6, units = c("in"))

D135 <- arrangeGrob(Fig.D135.per.meth, ncol=1)
ggsave(file="../D135.trt.pdf", D135, width =6, height = 6, units = c("in"))

D145 <- arrangeGrob(Fig.D145.per.meth, ncol=1)
ggsave(file="../D145.trt.pdf", D145, width =6, height = 6, units = c("in"))
