...
read in data
```{r}
amb_DMR <- fread('https://gannet.fish.washington.edu/metacarcinus/Pgenerosa/analyses/20230811/amb_AllTimes_DMR250bp_cov5x_rms_results_collapsed.tsv', sep = "\t", header = TRUE, stringsAsFactors = FALSE)

day10_DMR <- fread('https://gannet.fish.washington.edu/metacarcinus/Pgenerosa/analyses/20230811/day10_AllpH_DMR250bp_cov5x_rms_results_collapsed.tsv', sep = "\t", header = TRUE, stringsAsFactors = FALSE)

day135_DMR <- fread('https://gannet.fish.washington.edu/metacarcinus/Pgenerosa/analyses/20230811/day135_AllpH_DMR250bp_cov5x_rms_results_collapsed.tsv', sep = "\t", header = TRUE, stringsAsFactors = FALSE)

day145_DMR <- fread('https://gannet.fish.washington.edu/metacarcinus/Pgenerosa/analyses/20230811/day145_AllpH_DMR250bp_cov5x_rms_results_collapsed.tsv', sep = "\t", header = TRUE, stringsAsFactors = FALSE)

meta_data <- read.csv("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Data/Sample.Info.csv", stringsAsFactors = FALSE)

#remove hash from column names
colnames(amb_DMR)<- gsub("\\#", "", colnames(amb_DMR))
colnames(day10_DMR)<- gsub("\\#", "", colnames(day10_DMR))
colnames(day135_DMR)<- gsub("\\#", "", colnames(day135_DMR))
colnames(day145_DMR)<- gsub("\\#", "", colnames(day145_DMR))
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/DMR_mCpG_histograms_fEPI.jpg", width = 6, height = 8, units = "in", res = 300)
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/D10.DMR_heatmap_fEPI.jpg", width = 600, height = 1000)
heatmap.2(aov_0.05pH_d10DMR_mean_m, cexCol = 2, distfun = function(x) as.dist(1 - cor(t(x), use = "pa")), hclustfun = function(x) hclust(x,method = 'average'),key.xtickfun = function() {
  breaks = pretty(parent.frame()$breaks)
  #breaks = breaks[c(1,length(breaks))]
  list(at = parent.frame()$scale01(breaks),labels = breaks)},Colv=NA, col= rev(colorRampPalette(brewer.pal(10, "RdYlBu"))(256)), density.info = "none", trace = "none", scale = "row", labRow = FALSE,sepwidth=c(0.01,0.01),sepcolor="white",colsep=1:ncol(aov_0.05pH_d10DMR_mean_m),rowsep=1:nrow(aov_0.05pH_d10DMR_mean_m),lmat = rbind(c(0,3),c(2,1),c(4,0)),keysize=0.5, key.par = list(cex=1),lhei=c(1.5,4,1), lwid = c(1.5,4))
dev.off()
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/D135.DMR_heatmap_fEPI.jpg", width = 600, height = 1000)
heatmap.2(aov_0.05pH_d135DMR_mean_m, cexCol = 2, distfun = function(x) as.dist(1 - cor(t(x), use = "pa")), hclustfun = function(x) hclust(x,method = 'average'),key.xtickfun = function() {
  breaks = pretty(parent.frame()$breaks)
  #breaks = breaks[c(1,length(breaks))]
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/D145.DMR_heatmap_fEPI.jpg", width = 600, height = 1000)
heatmap.2(aov_0.05pH_d145DMR_mean_m, cexCol = 1.5, distfun = function(x) as.dist(1 - cor(t(x), use = "pa")), hclustfun = function(x) hclust(x,method = 'average'),key.xtickfun = function() {
  breaks = pretty(parent.frame()$breaks)
  #breaks = breaks[c(1,length(breaks))]
...
#calculated fold change in methylation between column pairs for d145
x <- (aov_0.05pH_d145DMR_mean_m[,2]/aov_0.05pH_d145DMR_mean_m[,1])-1
mean(x[x>0])
#SE
sd(x[x>0])/(sqrt(length(x[x>0])))
mean(x[x<0])
#SE
sd(x[x<0])/(sqrt(length(x[x<0])))

y <- (aov_0.05pH_d145DMR_mean_m[,4]/aov_0.05pH_d145DMR_mean_m[,3])-1
mean(y[y>0])
#SE
sd(y[y>0])/(sqrt(length(y[y>0])))
mean(y[y<0])
#SE
sd(y[y<0])/(sqrt(length(y[y<0])))

z <- (aov_0.05pH_d145DMR_mean_m[,6]/aov_0.05pH_d145DMR_mean_m[,5])-1
mean(z[z>0])
#SE
sd(z[z>0])/(sqrt(length(z[z>0])))
mean(z[z<0])
#SE
sd(z[z<0])/(sqrt(length(z[z<0])))
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/Time.DMR_heatmap_fEPI.jpg", width = 700, height = 1000)
heatmap.2(aov_0.05pH_ambDMR_mean_m,margins = c(10,20), cexCol = 2, distfun = function(x) as.dist(1 - cor(t(x), use = "pa")), hclustfun = function(x) hclust(x,method = 'average'),key.xtickfun = function() {
  breaks = pretty(parent.frame()$breaks)
  #breaks = breaks[c(1,length(breaks))]
...
write.csv(d10DMR_1way_aov_pH_modelsumm_wide,"/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_pH_d10DMR_fEPI.csv", row.names = FALSE, quote = FALSE)
...
write.csv(d135DMR_1way_aov_pH_modelsumm_wide,"/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_pH_d135DMR_fEPI.csv", row.names = FALSE, quote = FALSE)
...
write.csv(d145DMR_2way_aov_pH_modelsumm_wide,"/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_pH_d145DMR_fEPI.csv", row.names = FALSE, quote = FALSE)
...
write.csv(ambDMR_1way_aov_pH_modelsumm_wide,"/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_pH_timeDMR_fEPI.csv", row.names = FALSE, quote = FALSE)
...
aov_0.05_DMRs <- rbind(cbind(d10DMR_1way_aov_pH_modelsumm_wide[which(d10DMR_1way_aov_pH_modelsumm_wide$p.value_Initial.Treatment < 0.05),c("scaffold","start","end")],comparison = rep("day10", nrow(d10DMR_1way_aov_pH_modelsumm_wide[which(d10DMR_1way_aov_pH_modelsumm_wide$p.value_Initial.Treatment < 0.05),]))), cbind(d135DMR_1way_aov_pH_modelsumm_wide[which(d135DMR_1way_aov_pH_modelsumm_wide$p.value_Initial.Treatment < 0.05),c("scaffold","start","end")],comparison = rep("day135", nrow(d135DMR_1way_aov_pH_modelsumm_wide[which(d135DMR_1way_aov_pH_modelsumm_wide$p.value_Initial.Treatment < 0.05),]))),cbind(d145DMR_2way_aov_pH_modelsumm_wide[which(d145DMR_2way_aov_pH_modelsumm_wide$p.value_Initial.Treatment.Secondary.Treatment < 0.05),c("scaffold","start","end")],comparison = rep("day145", nrow(d145DMR_2way_aov_pH_modelsumm_wide[which(d145DMR_2way_aov_pH_modelsumm_wide$p.value_Initial.Treatment.Secondary.Treatment < 0.05),]))),cbind(ambDMR_1way_aov_pH_modelsumm_wide[which(ambDMR_1way_aov_pH_modelsumm_wide$p.value_TimePoint < 0.05),c("scaffold","start","end")],comparison = rep("time", nrow(ambDMR_1way_aov_pH_modelsumm_wide[which(ambDMR_1way_aov_pH_modelsumm_wide$p.value_TimePoint < 0.05),]))))
                       
#create a column for DMR length
aov_0.05_DMRs$length <- (as.numeric(aov_0.05_DMRs$end) - as.numeric(aov_0.05_DMRs$start))

#make violin plots
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/DMR_size_distributions_fEPI.jpg", width = 6, height = 4.5, units = "in", res = 300)
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/DMR_distribution_across_scaffolds_fEPI.jpg", width = 10, height = 5, units = "in", res = 300)
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/DMR_distribution_by_scaffold_position_fEPI.jpg", width = 6, height = 7, units = "in", res = 300)
...
#write out date
write.table(d10DMR_sig.bed, "/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_pH_d10DMR_fEPI.bed", sep = "\t",row.names = F, col.names = F, quote = F)
...
#write out date
write.table(d135DMR_sig.bed, "/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_pH_d135DMR_fEPI.bed", sep = "\t",row.names = F, col.names = F, quote = F)
...
#write out date
write.table(d145DMR_sig.bed, "/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_pH_d145DMR_fEPI.bed", sep = "\t",row.names = F, col.names = F, quote = F)
...
#write out date
write.table(ambDMR_sig.bed, "/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_time_ambDMR_fEPI.bed", sep = "\t",row.names = F, col.names = F, quote = F)

```

# Match Significant DMRs to genomic features
```{bash}
FILES="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/*DMR_fEPI.bed"

for f in $FILES
do
/home/shared/bedtools2/bin/intersectBed \
-a ${f} \
-b /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Data/Genome/Panopea-generosa-v1.0.a4.2Kbin.uniq.bed \
-wao \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/$(basename ${f%DMR.bed})_0817.txt
done
```
...
```{bash}
## remake feature file using 200 bp window instead of 2K windows

cat /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Data/Genome/Panopea-generosa-v1.0.a4.sort.bed |\
uniq |\
/home/shared/bedtools2/bin/windowMaker \
-b - \
-w 200 \
-i src |\
...
-i - |\
uniq \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Data/Genome/Panopea-generosa-v1.0.a4.200bin.uniq.bed
...
declare -a amb_day0="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-41_S38_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-42_S39_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-43_S40_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-44_S41_L005_5x.tab"

declare -a amb_day10="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-119_S31_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-120_S32_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-135_S35_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-136_S36_L005_5x.tab"

declare -a amb_day135="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-151_S2_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-152_S3_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-153_S4_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-154_S5_L002_5x.tab"

declare -a amb_day145="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-181_S16_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-182_S17_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-184_S18_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-185_S19_L003_5x.tab"

declare -a low_day10="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-103_S27_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-104_S28_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-127_S33_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-128_S34_L005_5x.tab"

declare -a low_day135="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-160_S7_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-161_S8_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-162_S9_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-159_S6_L002_5x.tab"

declare -a slow_day10="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-111_S29_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-113_S30_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-143_S37_L005_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-145_S38_L005_5x.tab"

declare -a slow_day135="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-167_S10_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-168_S11_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-169_S12_L002_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-170_S13_L002_5x.tab"

declare -a lamb_day145="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-175_S14_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-176_S15_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-193_S22_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-194_S23_L003_5x.tab"

declare -a slamb_day145="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-187_S20_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-188_S21_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-199_S24_L003_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-200_S25_L003_5x.tab"

declare -a ambl_day145="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-205_S26_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-206_S27_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-226_S34_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-227_S35_L004_5x.tab"

declare -a lowlow_day145="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-208_S28_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-209_S29_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-229_S36_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-230_S37_L004_5x.tab"

declare -a sllow_day145="/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-214_S30_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-215_S31_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-220_S32_L004_5x.tab 
/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/fEPI-221_S33_L004_5x.tab"
...
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/${f}.3xCpG.bed
done
...
cat /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/*day10*.3xCpG.bed |\
sort | \
uniq -c | \
awk '{if($1==3)print $2"\t"$3"\t"$4}' \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day10.3xCpG.allgrps.bed

# day 135 comparison

cat /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/*day135*.3xCpG.bed |\
sort | \
uniq -c | \
awk '{if($1==3)print $2"\t"$3"\t"$4}' \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day135.3xCpG.allgrps.bed

#day 145 comparison

cat /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/*day145*.3xCpG.bed |\
sort | \
uniq -c | \
awk '{if($1==6)print $2"\t"$3"\t"$4}' \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day145.3xCpG.allgrps.bed

#all ambient samples over time comparison

cat /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/amb_*.3xCpG.bed |\
sort | \
uniq -c | \
awk '{if($1==4)print $2"\t"$3"\t"$4}' \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/amb.3xCpG.allgrps.bed


## STEP 3. determine binned features that common CpGs overlap with (bedtools intersect)


FILES=/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/*.3xCpG.allgrps.bed
...
-b /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Data/Genome/Panopea-generosa-v1.0.a4.2Kbin.uniq.bed \
-wb \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/$(basename ${f%.3xCpG.allgrps.bed})_features.txt
done
...
/home/shared/bedtools2/bin/intersectBed \
-a ${f} \
-b /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Data/Genome/Panopea-generosa-v1.0.a4.200bin.uniq.bed \
-wb \
> /home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/$(basename ${f%.3xCpG.allgrps.bed})_200bpfeatures.txt
done
...
FILES=/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/*_features.txt
...
>/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/$(basename ${f%_features.txt})_features.3CpG.txt
done


FILES=/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/*_200bpfeatures.txt
...
uniq -c |\
awk '{if($1>2)print $2"\t"$3"\t"$4"\t"$5}'\
>/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/$(basename ${f%_features.txt})_200bpfeatures.3CpG.txt
done
```
...
amb_DMR_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_time_ambDMR_fEPI.bed_0817.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)

d10_DMR_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_pH_d10DMR_fEPI.bed_0817.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)

d135_DMR_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_pH_d135DMR_fEPI.bed_0817.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)

d145_DMR_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/aov_0.05_pH_d145DMR_fEPI.bed_0817.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)

# # read in features that covered regions (background) overlap with
# amb_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/amb_features.3CpG.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)
# 
# d10_feat <-read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day10_features.3CpG.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)
# 
# d135_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day135_features.3CpG.txt", header = FALSE,sep = "\t", stringsAsFactors = FALSE)
# 
# d145_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day145_features.3CpG.txt", header = FALSE,sep = "\t", stringsAsFactors = FALSE)





amb_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/amb_200bpfeatures.3CpG.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)

d10_feat <-read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day10_200bpfeatures.3CpG.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)

d135_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day135_200bpfeatures.3CpG.txt", header = FALSE,sep = "\t", stringsAsFactors = FALSE)

d145_feat <- read.table("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/output/day145_200bpfeatures.3CpG.txt", header = FALSE,sep = "\t", stringsAsFactors = FALSE)
```
...
amb_DMR_feat <- amb_DMR_feat[,-c(1:3,9)]
d10_DMR_feat <- d10_DMR_feat[,-c(1:3,9)]
d135_DMR_feat <- d135_DMR_feat[,-c(1:3,9)]
d145_DMR_feat <- d145_DMR_feat[,-c(1:3,9)]
...
DMR_feat$comparison <- gsub("pH_d", "day ", DMR_feat$comparison)
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/pH.DMR_genom_feat_stacked_barplot_fEPI.jpg", width = 6, height = 5, units = "in", res =300)
...
jpeg("/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/Time.DMR_genom_feat_stacked_barplot_fEPI.jpg", width = 4, height = 7, units = "in", res =300)
...
write.csv(all_chi,"/home/shared/8TB_HDD_02/strigg/Geoduck_Meth/RAnalysis/Output/DMR_genom_feat_chi_table_fEPI.csv", row.names = FALSE, quote = FALSE)
